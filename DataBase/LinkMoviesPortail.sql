...
-- Généré le :  Ven 06 Novembre 2015 à 08:36
...
--
-- Structure de la table `LinkMoviesPortail`
--
...
--
-- Contenu de la table `LinkMoviesPortail`
--
...
--
-- Index pour la table `LinkMoviesPortail`
--
...
--
-- AUTO_INCREMENT pour la table `LinkMoviesPortail`
--
ALTER TABLE `LinkMoviesPortail`
